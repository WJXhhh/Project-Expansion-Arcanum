...
Project Expansion: Arcanum is an independent maintained fork of
[Project Expansion](https://github.com/DonovanDMC/ProjectExpansion).
...
ProjectE attribution and the original MIT License are retained from the
upstream project. See `LICENSE` for the complete license text.
